<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Merch_Bundle.ascx.cs" 
    Inherits="WillCallWeb.Admin.AdminControls.Merch_Bundle" %>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" ItemStyle-Width="100px">
                                <HeaderTemplate>
                                    <div class="cmdsection">
                                        <asp:Button ID="btnNew" runat="server" CausesValidation="false" ToolTip="Add New" 
                                            Cssclass="btnmed" CommandName="New" Width="50px" Text="Add New" />  
                                    </div>
                                </HeaderTemplate>                    
                                <ItemTemplate>
