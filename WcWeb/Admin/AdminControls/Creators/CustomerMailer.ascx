<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerMailer.ascx.cs" Inherits="WillCallWeb.Admin.AdminControls.Creators.CustomerMailer" %>
<div id="srceditor">
    <div id="mailereditor">
        <div class="jqhead rounded">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="hedtbl">
                <tr>
                    ...
                    <td style="width:100%;">
                        Params in current template: <%= string.Join(", ", ParamNames.ToArray()) %> - format is &lt;PARAM&gt;PARAMNAME&lt;PARAM&gt;
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="jqpnl rounded">
            <table border="0" cellpadding="0" cellspacing="0" width="1100px" class="edittabl">
                <tr>
                    <th colspan="2" style="width:530px;text-align:center;">Create Template
                    ...
                    <td>&nbsp;</td>
                    <th style="width:530px;text-align:center;">
                ...
                <tr>
                    ...
                    <td rowspan="10" style="vertical-align:top !important;">
                        <div class="jqinstruction rounded" style="width:530px;" >
                            <div><asp:Literal ID="litSubject" runat="server" OnDataBinding="litSubject_DataBinding" /></div>
                            <div style="border:solid red 0px;"><asp:Literal ID="litSample" runat="server" EnableViewState="false" OnDataBinding="litSample_DataBinding" /></div>
                        </div>
                    </td>
                </tr>
                <tr>
