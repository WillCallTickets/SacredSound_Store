...
{
    public partial class Editor_MerchSize : BaseControl
    {
        private MerchSizeCollection OrderedCollection
        {
            get
            {
                MerchSizeCollection coll = new MerchSizeCollection();
                coll.AddRange(_Lookits.MerchSizes);
                if (coll.Count > 1)
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.HasControls() && this.UpdatePanel1.Visible)
                Atx.RegisterJQueryScript_BlockUI_AjaxMethod(this.UpdatePanel1, "#merchsizeeditor", true);
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (typ == DataControlRowType.DataRow)
            {
                ...
                {
                    MerchSize entity = (MerchSize)e.Row.DataItem;
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                _Lookits.MerchSizes.DeleteFromCollection(idx);
                grid.SelectedIndex = 0;
                grid.DataBind();
            }
            catch (Exception ex)
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (cmd)
            {
                case "up":
                case "down":
                    MerchSize moved = _Lookits.MerchSizes.ReorderItem(int.Parse(e.CommandArgument.ToString()), cmd);
        ...
        protected void FormView1_DataBinding(object sender, EventArgs e)
        {
            ...
            MerchSizeCollection selected = new MerchSizeCollection();
            MerchSize addSize = (MerchSize)OrderedCollection.Find(idx);
            if(addSize != null)
                selected.Add(addSize);
        ...
        protected void FormView1_ItemInserting(object sender, FormViewInsertEventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                try
                {
                    ...
                    TextBox code = (TextBox)form.FindControl("txtCode");

                    MerchSize newItem = _Lookits.MerchSizes.AddToCollection(name.Text.Trim(), code.Text.Trim());

                    _Lookits.RefreshLookup(_Enums.LookupTableNames.MerchSizes.ToString());
        ...
        protected void FormView1_ItemUpdating(object sender, FormViewUpdateEventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                try
                {
                    ...
                    MerchSize entity = (MerchSize)_Lookits.MerchSizes.Find(idx);

                    if (entity != null && name != null && code != null)
                    {
                        if (entity.Name != name.Text.Trim())
                            entity.Name = name.Text.Trim();
                        if (entity.Code != code.Text.Trim())
                            entity.Code = code.Text.Trim();
