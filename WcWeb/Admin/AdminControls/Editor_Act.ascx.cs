...
{
    /// <summary>
    /// can only edit picture in editor mode
    /// </summary>
    [ToolboxData("<{0}:Editor_Act runat=\"Server\" AbbreviatedDisplay=\"false\" DisplayTitle=\"true\" TitleText=\"ACT EDITOR\" SelectText=\"SELECT ACT\" ></{0}:Editor_Act>")]
    public partial class Editor_Act : BaseControl
    {
        #region Wizard
        ...
        protected void wizEdit_ActiveStepChanged(object sender, EventArgs e)
        {
            ...
            switch(wiz.ActiveStep.ID.ToLower())
            {
                ...
                case "images":
                    litImage.DataBind();
                    txtImageName.Text = Server.HtmlEncode(Entity.Name);
                    break;
            }
        }
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (Utils.Validation.IsInteger(val))
                Atx.CurrentActId = int.Parse(val);
            else
                Atx.CurrentActId = 0;
        ...
        public delegate void SelectedEditActChangedEventHandler(object sender, WillCallWeb.Admin.AdminEvent.EditorEntityChangedEventArgs e);
        ...
        public virtual void OnSelectedActChanged(WillCallWeb.Admin.AdminEvent.EditorEntityChangedEventArgs e)
        {
        ...
        protected void litImage_DataBinding(object sender, EventArgs e)
        {
            if (wizEdit.ActiveStep.ID.ToLower() == "images")
            {
                ...
                if (useJcrop)
                    jcropId = string.Format("id=\"jcropper-act\" ");

                lit.Text = string.Format("<img src=\"/Images/spacer.gif\" alt=\"\" width=\"{0}px\" height=\"1px\" />", _Config._ActThumbSizeMax.ToString());

                bool entityHasPicture = (Entity != null && Entity.PictureUrl != null && Entity.PictureUrl.Trim().Length > 0);
                if (entityHasPicture)
                {
                    int width = (Entity.PicWidth < _Config._ActThumbSizeMax) ? Entity.PicWidth : _Config._ActThumbSizeMax;
                    ...
                    if (Entity != null && Entity.PictureUrl != null && Entity.PictureUrl.Trim().Length > 0)
                    {
                            ...
                            && w1.Trim().Length > 0 && h1.Trim().Length > 0 && x1.Trim().Length > 0 && y1.Trim().Length > 0)
                        {
                            ...
                            using (MemoryStream ms = new MemoryStream(CropImage, 0, CropImage.Length))
                            {
                                ...
                                {
                                    //save the image to the acts directory
        ...
        private string _titleText = "ACT EDITOR";
        ...
        private string _selectText = "SELECT ACT";
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            //set up crop control
            //string script = " $('#jcropper-act').Jcrop({onSelect: showCoords,onChange: showCoords,bgColor: '#333333',bgOpacity: .7, ";
            ...
            regFunc.AppendFormat("function ActItemSelected(source, eventArgs) {{ {0}", Environment.NewLine);
        ...
        protected void pnlShowList_DataBinding(object sender, EventArgs e)
        {
            ...
            if (this.Page.ToString().ToLower().IndexOf("entityeditor") != -1 &&
                (_Config._Site_Entity_Mode != _Enums.SiteEntityMode.Act ||
                (Entity.Name.ToLower() != _Config._Default_ActName))
                )
            {
                p.Visible = true;
            }
        ...
        protected void rptShowList_ItemCommand(object sender, RepeaterCommandEventArgs e)
        {
            ...
            switch (cmd)
            {
                case "viewshow":
                    ...
                    base.Redirect("ShowEditor.aspx?p=acts");
                    break;
            }
        }
        ...
        protected void rdoSearch_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtSelection.Text = string.Empty;
            Ctx.SearchLike_Act = (rbl.SelectedValue == "true");
        }
        ...
        protected void rdoSearch_Load(object sender, EventArgs e)
        {
            ...
            ListItem li = rbl.Items.FindByValue(Ctx.SearchLike_Act.ToString().ToLower());
            if (li != null)
                li.Selected = true;
        }
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            if (upload != null && upload.HasFile)
            {
                ...
                {   
                    ...
                    string pathFile = string.Format("{0}{1}", _ImageManager._ActImageStorage_Local, fileName);
                    ...
                    if (System.IO.File.Exists(mappedFile))
                    {
                        ...
                        mappedFile = Server.MapPath(string.Format("{0}{1}", _ImageManager._ActImageStorage_Local, fileName));
                    }
