...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		// user logs on your system.
 		//HttpCookie c = HttpContext.Current.Request.Cookies["ifk"];
 		//return (c != null && c.Value != null && c.Value == "1");
 		
		//return true;

        //there is a bug with the flash uploader and how it handles cookies
        //http://cksource.com/forums/viewtopic.php?f=10&t=23616&start=20
        //http://docs.cksource.com/CKFinder_2.x/Developers_Guide/ASP.NET/Troubleshooting
        string userd = Request.UserAgent.ToLower();

        if (userd.IndexOf(" flash") != -1)
            return true;
	...
	public override void SetConfig()
	{
		...
		BaseUrl = "/WillCallResources/FCKs/";
