...
{
	/// <summary>
	/// Strongly-typed collection for the LogArchive class.
	/// </summary>
    [Serializable]
	public partial class LogArchiveCollection : ActiveList<LogArchive, LogArchiveCollection>
	{	   
		public LogArchiveCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LogArchiveCollection</returns>
		public LogArchiveCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the LogArchive table.
	/// </summary>
	[Serializable]
	public partial class LogArchive : ActiveRecord<LogArchive>, IActiveRecord
	{
		...
		public LogArchive(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LogArchive(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LogArchive(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LogArchive", TableType.Table, DataService.GetInstance("ErrorLog"));
				...
				DataService.Providers["ErrorLog"].AddSchema("LogArchive",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varId,DateTime varDateX,string varSource,string varMessage,string varForm,string varQuerystring,string varTargetSite,string varStackTrace,string varReferrer,string varIpAddress,string varEmail,string varApplicationName)
		{
