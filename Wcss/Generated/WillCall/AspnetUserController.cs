...
namespace Wcss
{
    ...
    public partial class AspnetUserController
    {
	    ...
	    public void Update(Guid ApplicationId,Guid UserId,string UserName,string LoweredUserName,string MobileAlias,bool IsAnonymous,DateTime LastActivityDate,int CustomerId)
	    {
		    AspnetUser item = new AspnetUser();
	        item.MarkOld();
	        item.IsLoaded = true;
