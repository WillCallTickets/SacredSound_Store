...
{
	/// <summary>
	/// Strongly-typed collection for the MailQueueArchive class.
	/// </summary>
    [Serializable]
	public partial class MailQueueArchiveCollection : ActiveList<MailQueueArchive, MailQueueArchiveCollection>
	{	   
		public MailQueueArchiveCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MailQueueArchiveCollection</returns>
		public MailQueueArchiveCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                MailQueueArchive o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MailQueueArchive table.
	/// </summary>
	[Serializable]
	public partial class MailQueueArchive : ActiveRecord<MailQueueArchive>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public MailQueueArchive()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public MailQueueArchive(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MailQueueArchive(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MailQueueArchive(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MailQueueArchive", TableType.Table, DataService.GetInstance("WillCall"));
				...
				colvarTEmailLetterId.IsForeignKey = false;
				colvarTEmailLetterId.IsReadOnly = false;
				colvarTEmailLetterId.DefaultSetting = @"";
				colvarTEmailLetterId.ForeignKeyTableName = "";
				...
				colvarTSubscriptionEmailId.IsForeignKey = false;
				colvarTSubscriptionEmailId.IsReadOnly = false;
				colvarTSubscriptionEmailId.DefaultSetting = @"";
				colvarTSubscriptionEmailId.ForeignKeyTableName = "";
				...
				colvarAttemptsRemaining.DefaultSetting = @"";
				...
				DataService.Providers["WillCall"].AddSchema("MailQueueArchive",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varId,DateTime? varDtStamp,DateTime? varDateToProcess,DateTime? varDateProcessed,string varFromName,string varFromAddress,string varToAddress,string varCc,string varBcc,string varStatus,int? varTEmailLetterId,int? varTSubscriptionEmailId,int? varPriority,bool? varBMassMailer,Guid? varThreadLock,int? varAttemptsRemaining,Guid varApplicationId)
		{
