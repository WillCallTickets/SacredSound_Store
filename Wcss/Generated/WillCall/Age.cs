...
{
	/// <summary>
	/// Strongly-typed collection for the Age class.
	/// </summary>
    [Serializable]
	public partial class AgeCollection : ActiveList<Age, AgeCollection>
	{	   
		public AgeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AgeCollection</returns>
		public AgeCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Age table.
	/// </summary>
	[Serializable]
	public partial class Age : ActiveRecord<Age>, IActiveRecord
	{
		...
		public Age(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Age(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Age", TableType.Table, DataService.GetInstance("WillCall"));
				...
				DataService.Providers["WillCall"].AddSchema("Age",schema);
			}
		}
		#endregion
		...
		public Wcss.ShowDateCollection ShowDateRecords()
		{
			...
			{
				colShowDateRecords = new Wcss.ShowDateCollection().Where(ShowDate.Columns.TAgeId, Id).Load();
		...
		void colShowDateRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colShowDateRecords[e.NewIndex].TAgeId = Id;
				colShowDateRecords.ListChanged += new ListChangedEventHandler(colShowDateRecords_ListChanged);
            }
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetApplication ActiveRecord object related to this Age
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varName,DateTime varDtStamp,Guid varApplicationId)
		{
			Age item = new Age();
		...
		/// </summary>
		public static void Update(int varId,string varName,DateTime varDtStamp,Guid varApplicationId)
		{
			Age item = new Age();
