...
{
	/// <summary>
	/// Strongly-typed collection for the MerchSize class.
	/// </summary>
    [Serializable]
	public partial class MerchSizeCollection : ActiveList<MerchSize, MerchSizeCollection>
	{	   
		public MerchSizeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MerchSizeCollection</returns>
		public MerchSizeCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MerchSize table.
	/// </summary>
	[Serializable]
	public partial class MerchSize : ActiveRecord<MerchSize>, IActiveRecord
	{
		...
		public MerchSize(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MerchSize(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MerchSize", TableType.Table, DataService.GetInstance("WillCall"));
				...
				DataService.Providers["WillCall"].AddSchema("MerchSize",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetApplication ActiveRecord object related to this MerchSize
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varName,int varIDisplayOrder,string varCode,DateTime varDtStamp,Guid varApplicationId)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,int varIDisplayOrder,string varCode,DateTime varDtStamp,Guid varApplicationId)
		{
			MerchSize item = new MerchSize();
