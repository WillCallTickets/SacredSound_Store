...
{
	/// <summary>
	/// Strongly-typed collection for the EventQArchive class.
	/// </summary>
    [Serializable]
	public partial class EventQArchiveCollection : ActiveList<EventQArchive, EventQArchiveCollection>
	{	   
		public EventQArchiveCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>EventQArchiveCollection</returns>
		public EventQArchiveCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                EventQArchive o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the EventQArchive table.
	/// </summary>
	[Serializable]
	public partial class EventQArchive : ActiveRecord<EventQArchive>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public EventQArchive()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public EventQArchive(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public EventQArchive(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public EventQArchive(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("EventQArchive", TableType.Table, DataService.GetInstance("WillCall"));
				...
				DataService.Providers["WillCall"].AddSchema("EventQArchive",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varId,DateTime? varDtStamp,DateTime? varDateToProcess,DateTime? varDateProcessed,string varStatus,Guid? varThreadlock,int? varAttemptsRemaining,int? varIPriority,Guid? varCreatorId,string varCreatorName,Guid? varUserId,string varUserName,string varContext,string varVerb,string varOldValue,string varNewValue,string varDescription,string varIp,Guid varApplicationId)
		{
