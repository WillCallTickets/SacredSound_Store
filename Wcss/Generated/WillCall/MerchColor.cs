...
{
	/// <summary>
	/// Strongly-typed collection for the MerchColor class.
	/// </summary>
    [Serializable]
	public partial class MerchColorCollection : ActiveList<MerchColor, MerchColorCollection>
	{	   
		public MerchColorCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MerchColorCollection</returns>
		public MerchColorCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MerchColor table.
	/// </summary>
	[Serializable]
	public partial class MerchColor : ActiveRecord<MerchColor>, IActiveRecord
	{
		...
		public MerchColor(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MerchColor(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MerchColor(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MerchColor", TableType.Table, DataService.GetInstance("WillCall"));
				...
				DataService.Providers["WillCall"].AddSchema("MerchColor",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetApplication ActiveRecord object related to this MerchColor
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varName,int varIDisplayOrder,string varImageUrl,DateTime varDtStamp,Guid varApplicationId)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,int varIDisplayOrder,string varImageUrl,DateTime varDtStamp,Guid varApplicationId)
		{
			MerchColor item = new MerchColor();
