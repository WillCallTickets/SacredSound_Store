...
namespace Utils
{
	...
	public class BarCode
	{
		...
		public BarCode(string fontPath, int barSize, string code, string title, bool showCodeString)
		{
			Code39 c39 = new Code39();
			
			c39.FontFamilyName = "Free 3 of 9";
			c39.FontFileName = fontPath;
			...
			this.image = c39.GenerateBarcode(code.ToUpper());
		}
			...
			private Font Code39Font
			{
				get
				{
					if (_c39Font==null)
					{
						...
						string mapped = System.Web.HttpContext.Current.Server.MapPath(_c39FontFileName);
						pfc.AddFontFile(mapped);
